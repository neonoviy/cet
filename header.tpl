...
<link rel="stylesheet" type="text/css" href="{$_config.manager_url}/templates/cet/customizeme.css">
</head>
...
<div id="modx-container">
    <div id="modx-header">
                        ...
                        <li id="modx-home-dashboard">
                            <a href="?" class="tophomelink" title="MODX {$_config.settings_version} ({$_config.settings_distro})
        ...
        <div id="modAB"></div>
        <div id="modx-leftbar">
      					  <div id="modx-navbar"><div class="menuspace">
